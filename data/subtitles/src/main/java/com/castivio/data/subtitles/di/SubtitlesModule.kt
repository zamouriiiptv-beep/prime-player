...
object SubtitlesModule {
    ...
    /**
     * Its own client, not the one the playlists use.
     *
    ...
    @Provides
    @Singleton
    fun api(client: OkHttpClient, credentials: OpenSubtitlesCredentials): OpenSubtitlesApi =
        OpenSubtitlesApi(client, credentials)
